...
int main(){
    ...
    cout<<"1. Warteg Andi				Rp. 13000"<<endl;
    cout<<"2. Bakso Tejo				Rp. 27000"<<endl;
    cout<<"3. Mixue			Rp. 17000"<<endl;
    cout<<"4. Capucino			Rp. 5000"<<endl;
    cout<<"5. Nasi bakar            Rp.1000"<<endl;
    cout<<"--------------------------------------------------------------"<<endl;
